...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "NYX Technologies",
    description: [
      "Designing and implementing backend services and LLM-driven features for an AI hospital dashboard.",
      "Integrating machine learning models with backend pipelines and database storage.",
      "Collaborating on frontend-backend linking to ensure production-ready UX and telemetry.",
      "Focusing on scalable, maintainable systems and clear documentation.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.FASTAPI,
  ...
  },
  {
    ...
    company: "Alerix",
    description: [
      "Built end-to-end features connecting frontend dashboards to backend ML services.",
      "Implemented data pipelines, APIs and integrated models for inference and monitoring.",
      "Worked on frontend components and ensured smooth integration with backend endpoints.",
      "Followed best practices for testing and deployment in staging environments.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.TS,
